...
export default function ShowAllBuyer() {
    const[buyer,setBuyer]=useState();

    useEffect(() => {
        const firstURL = 'http://localhost:9000/getallbuyers';
        const secondURL = 'http://localhost:8080/getallbuyers';
    ...
    {
       fetch("http://localhost:8080/deletebuyer/"+id,{method : "DELETE"})
       .then(resp => {
           if(resp.ok)
           { 
               console.log(resp)
    ...
    <div className="row">
        ...
        <div className='nav-item'>
                    <ul className="nav navbar">
                        ...
                        <Link to="/getallbuyers" className="nav-link">ShowAllBuyer</Link>
                        </li>
                        <li className="nav-item">
